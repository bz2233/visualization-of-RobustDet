...
from models.robust_ssd import RobustSSD
...
class SSD(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "model_path"        : '/home/f8/zrd/RobustDet/weights/RobusDet_VOC_mtd.pth',
        "classes_path"      : '/home/f8/zrd/RobustDet/model_data/voc_classes.txt',
        #---------------------------------------------------------------------#
    ...
    def generate(self, onnx=False):
        ...
        self.net = build_robust_ssd('test', 300, 21, CFR=False, CFR_layer=21, K=4, backbone='vgg')
    ...
    def detect_image(self, image, crop = False, count = False):
        ...
        for i, c in list(enumerate(top_label)):
            ...
            if top - label_size[1] >= 0:
                text_origin = np.array([top, left - label_size[1]])
            else:
                text_origin = np.array([top, left + 1])
